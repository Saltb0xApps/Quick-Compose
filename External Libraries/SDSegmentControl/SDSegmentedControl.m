...
const NSTimeInterval kSDSegmentedControlDefaultDuration = 0;
...
- (void)commonInit
{
    ...
    self._selectedStainView.backgroundColor = [UIColor colorWithWhite:0.816 alpha:0];
}
...
+ (void)initialize
{
    ...
    [appearance setTitleColor:[UIColor colorWithWhite:0.5 alpha:1] forState:UIControlStateNormal];
...
+ (void)initialize
{
    ...
    appearance.shadowOffset = CGSizeMake(0, 0.5);
    appearance.shadowBlur = 2.5;
    appearance.shadowColor = [UIColor colorWithWhite:0.05 alpha:1];
    appearance.innerStrokeLineWidth = 0.05;
